...
<b>Feature</b><br/>
<p style="font-size:20px">1.Friend Request Sent<br/>
2. Conversation Each Other<br/>
3. Like and Comment Post<br/>
4. Image Upload<br/>
5.Profile Url<br/>
6.Live Online friend See<br></p>
Language Use <u><b>PHP,Jquery,AJAX,mysql</b></u><br/>
Local Server XAMPP
<br/>
<b style="font-size:20px">Database Description</b>
<hr/>
-- phpMyAdmin SQL Dump
-- version 4.3.11
