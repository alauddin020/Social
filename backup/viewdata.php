...
$con = mysqli_connect("localhost","root","","fa");
  ...
  color:#36538D;"><?php echo''.$row['uname'].'' ?></a>
    ...
    <div class="card-body" style="margin-top: -45px;max-width: 495px;">
     ...
     <?php if($row['pimage']!='')
      {
        echo'<img src="'.$row['pimage'].'" width="460">';
      } ?>
    </div> 
...
<div id="commentView">
  <div class="row">
      <div class="col-md-1">
        <img src="images/<?php echo''.$ownview['uphoto'].'' ?>" height="30" width="30" style="border-radius: 50%">
      </div>
      <div class="col-md-10">
          <a href="<?php echo''.$ownview['uusername'].'' ?>"> <h6><?php echo''.$ownview['uname'].'' ?></h6></a>
      <p><?php echo''.$viewpost['commenttext'].'' ?></p>
      </div>
</div>
</div>
        <div class="row">
            <div class="col col-lg-1">
              <img src="images/<?php echo''.$acomment.'' ?>" height="30" width="30" style="border-radius: 50%">
            </div>
            <form action="model/addcomment.php" method="POST">
              <div class="col col-md-11">
              <input type="hidden" name="postid" id="postid" value="<?php echo''.$row['pid'].'' ?>">
              <input type="text" class="form-control" name="commentpost" placeholder="press enter" id="commentpost" style="border-radius: 3%">
              <input type="submit" name="comment" value="Addcomment" class="btn btn-primary btn-sm">
            </div>
            </form>
        </div>
    </div>
